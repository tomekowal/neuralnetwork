...
object AppKohonen extends App {
    ...
    learn(inputs, (0.0, 1.0), List((8000, 0.06, 1.0, 1, 3), (8000, 0.03, 0.5, 1, 2), (8000, 0.015, 0.25, 1, 1), (8000, 0.0075, 0.125, 1, 0)))
    printResults(nn, inputs, "Obrazki")
    
    learn(our, (0.0, 1.0), List((8000, 0.06, 0, 1, 3), (8000, 0.03, 0.0, 1, 2), (8000, 0.015, 0.0, 1, 1), (8000, 0.0075, 0.0, 1, 0)))
